...
public final class TestElemental {
	...
	public static void main(String[] args) throws JDOMException, IOException {
        ...
        try {
            Document doc = saxBuilder.build(new StringReader(RESTGet("http://10.26.78.41/api/presets?page=2&per_page=100")));
            System.out.println(doc.getRootElement().getChildren().get(0));
        ...
        /*
        String exampleProfile = "<job><input><file_input><uri>"
        		+ input // "/data/server/elemental.mov"
        		+ "</uri></file_input></input><profile>"
        		+ input //"1"
        		+ "</profile></job>"
        		*/
        
        String examplePreset = 
        		"<job><input><file_input><uri>"
        		+ "/data/mnt/ifs/Kevin_Kha/Misc_Projects/Ads/Content/FastOnly/FixedProfile/Boxing/Boxing_1.ts" //"/data/server/elemental.mov"
        		+ "</uri></file_input></input>"
        		+ "<priority>"
        		+ "50" //priority (50)
        		+ "</priority>"
        		...
        		+ "<output_group>"
        		+ "<order>1</order>"
        		+ "<apple_live_group_settings><destination><uri>"
        		+ "/data/mnt/ifs/Kevin_Kha/Misc_Projects/Ads/Content/FastOnly/FixedProfile/Boxing" //output "/data/server/outgoing/hls_output"
        		+ "</uri></destination></apple_live_group_settings>"
        		+ "<type>"
        		+ "apple_live_group_settings"
        		+ "</type>"
        		
        		+ "<output>"
        		+ "<stream_assembly_name>"
        		+ "stream_1"
        		+ "</stream_assembly_name>"
        		+ "<name_modifier>"
        		+ "_high"
